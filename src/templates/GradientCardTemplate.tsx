...
export const GradientCardTemplate = () => {
    ...
    return (
        <div className="w-full min-h-[600px] flex items-center justify-center bg-black rounded-xl overflow-hidden p-8">
...
export default GradientCardTemplate;
