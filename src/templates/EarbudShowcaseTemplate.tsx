...
const PRODUCT_DATA: Record<ProductId, ProductData> = {
    left: {
        ...
        image: 'https://images.unsplash.com/photo-1610427382029-79737da2af9e?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3', // Placeholder
        colors: {
    ...
    right: {
        ...
        image: 'https://images.unsplash.com/photo-1590658268037-6bf12165a8df?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3', // Placeholder
        colors: {
                    ...
                    >
                        {activeId === opt.id && (
                            <motion.div
                                ...
                                transition={{ type: 'spring', stiffness: 220, damping: 22 } as any}
                            />
                        )}
...
export default function EarbudShowcaseTemplate() {
    ...
    return (
        <div className="relative min-h-[600px] w-full bg-black text-zinc-100 overflow-hidden selection:bg-zinc-800 flex flex-col items-center justify-center rounded-2xl">
